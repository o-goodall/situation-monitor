...
<style>
  ...
  .mobile-nav-link {
    ...
    font-family:'Poison',monospace; font-size:.78rem; font-weight:700;
  ...
  .mobile-theme-toggle {
    ...
    color:rgba(255,255,255,.6); font-family:'Poison',monospace;
  ...
  .mobile-section-title {
    padding:12px 24px 8px; font-family:'Poison',monospace;
