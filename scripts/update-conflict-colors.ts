...
const KNOWN_COUNTRY_NAMES = new Set<string>([
  ...
  'Brazil','Bhutan','Bulgaria','Burkina Faso','Burundi','Cambodia','Cameroon','Canada','Central African Republic',
  'Chad','Chile','China','Colombia','Croatia','Cuba','Czech Republic',
  'DR Congo','Democratic Republic of the Congo','Denmark','Ecuador','Egypt',
  'El Salvador','Eritrea','Ethiopia','Finland','France','Gambia','Georgia','Germany','Ghana',
  ...
  'Laos','Lebanon','Libya','Lithuania','Madagascar','Malawi','Malaysia','Mali',
  ...
  'Saudi Arabia','Sahrawi Republic','Senegal','Sierra Leone','Somalia','South Africa',
